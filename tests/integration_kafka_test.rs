...
fn expensive_computation<'a>(msg: OwnedMessage) -> String {
    ...
    thread::sleep(Duration::from_millis(100 % 5000));
    println!(
...
async fn test_scouter_consumer() {
    ...
    let group_id = "scouter".to_string();
    let input_topic = "scouter_monitoring".to_string();
    let output_topic = "scouter_monitoring".to_string();
    let num_workers = 10;
